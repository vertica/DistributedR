...
## nSplits: number of partitions in the darray (it is an optional argument)
db2darray <- function(tableName, features = list(...), conf, nSplits) {
...
# Example:
# loadedSamples <- db2darray("mortgage", list("mltvspline1", "mltvspline2", "agespline1", "agespline2", "hpichgspline", "ficospline"), conf="RDev")
