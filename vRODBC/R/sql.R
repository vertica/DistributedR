...
#
# Change Log - vRODBC:
# Modification to sqlQuery function to enable character vectors 
# conversion to factor only if options("stringsAsFactors") is 
# set to TRUE, else it is returned as is.
#
# Date         Name
# ------------------------
             ...
             verbose = FALSE, errors = TRUE, ...)
{
    ...
    if(!odbcValidChannel(destchannel))
       stop("destination argument is not an open vRODBC channel")
